...
const targetValues = {
    totalMembers: props.stats.users,
    totalPermissions: props.stats.permissions,
    totalCategories: props.stats.categories,
    fiches: props.stats.fiches,
};
// const targetValues = {
//     totalMembers: 127.68,
    ...
    <div class="grid grid-cols-1 gap-4 px-6 mt-8 sm:grid-cols-4 sm:px-8">
        ...
        <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div class="px-4 text-gray-700">
                ...
                <p class="text-3xl">{{ animatedValues.fiches.toFixed(0) }}</p>
            </div>
        </div>
    </div>
</template>
