<template>
    <footer class="pt-10 pb-7 bg-[#F3F4F6]">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                class="grid max-md:grid-cols-1 md:grid-cols-2 gap-10 pb-5 border-b-2"
            >
                <div
                    class="flex flex-col gap-8 xl:gap-14 w-full lg:max-w-full mx-auto"
                >
                    <div class="flex flex-col gap-8">
                        <h2
                            class="font-manrope font-bold text-3xl leading-snug text-accent max-[470px]:text-center"
                        >
                            Begin Your Project <br />Journey!
                        </h2>
                        <p
                            class="text-base font-normal text-gray max-[470px]:text-center"
                        >
                            Take the First Step Towards Success!
                        </p>
                        <div
                            class="flex items-center max-[470px]:justify-center gap-5"
                        >
                            <a
                                href="javascript:;"
                                class="p-2 text-black rounded transition-all duration-500 hover:rounded-full hover:bg-accent focus-within:bg-accent hover:text-white focus-within:outline-0 focus-within:text-white"
                            >
                                <svg
                            ...
                            <a
                                href="javascript:;"
                                class="p-2 text-black rounded transition-all duration-500 hover:rounded-full hover:bg-accent focus-within:bg-accent hover:text-white focus-within:outline-0 focus-within:text-accent"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        class="fill-white transition-all divide-gray-500 group-hover:fill-accent group-focus-within:fill-accent"
                    ...
                    <div
                        class="flex flex-col min-[470px]:flex-row min-[470px]:items-center gap-3"
                    >
                        <button
                            class="flex items-center max-[470px]:justify-center gap-2 py-3 pr-5 pl-7 rounded-full text-base font-semibold text-white bg-accent shadow-transparent shadow-sm transition-all duration-500 hover:shadow-accent hover:bg-white hover:text-accent"
                        >
                            Start Project
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button
                            class="flex items-center max-[470px]:justify-center gap-2 border-2 border-accent py-2.5 pr-5 pl-7 rounded-full text-base font-semibold text-accent bg-white shadow-transparent shadow-sm transition-all duration-500 hover:shadow-accent hover:bg-white hover:text-accent"
                        >
                            Contact Us
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                    class="w-full lg:max-w-full mx-auto flex flex-col min-[470px]:flex-row justify-between gap-6 sm:gap-20 md:gap-10 xl:gap-24"
                >
                    <div class="">
                        <h6
                            class="text-lg font-medium text-gray mb-7 max-[470px]:text-center"
                        >
                            Pagedone
                        </h6>
                        <ul
                            class="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6"
                        >
                            <li>
                                <a
                                    href="javascript:;"
                                    class="text-base font-normal max-lg:text-center text-gray whitespace-nowrap transition-all duration-300 hover:text-accent focus-within:outline-0 focus-within:text-accent"
                                    >Home</a
                                >
                            </li>
                            <li>
            ...
            <div
                class="flex flex-col-reverse gap-5 sm:flex-row items-center first-letter:items-center justify-between pt-3"
            >
                <p class="font-normal text-sm text-gray">
                ...
                <ul class="flex items-center gap-9">
                    <li>
                        <a
                            href="javascript:;"
                            class="text-gray text-sm font-normal transition-all duration-300 hover:text-accent focus-within:outline-0 focus-within:text-accent"
                            >Terms</a
                        >
                    </li>
                    <li>
