...
<template>
    <header>
        <nav class="bg-white py-2 shadow-xl">
            <div class="flex items-center font-medium justify-around px-10">
                <div
                    class="flex z-50 py-5 justify-between md:justify-center max-md:w-full md:w-[50%] items-center"
                >
                    <div class="flex items-center gap-x-2">
                        <svg
                            @click="toggleSidebar"
                            class="fill-accent w-[50px] h-[50px]"
                            viewBox="0 0 512 512"
                            id="book"
                            fill="currentColor"
                        >
                ...
                <ul
                    class="md:flex md:justify-center hidden items-center md:gap-x-12 text-lg w-full"
                >
                    <li>
                        <Link
                            href="/"
                ...
                <div class="md:block hidden">
                    <Link :href="route('login')" class="text-white bg-accent rounded-full px-4 py-2">
                        Login
                    </Link>
                </div>
                <!-- mobile menu -->
                <ul
                    class="md:hidden bg-white absolute w-full min-h-screen bottom-0 py-24 flex flex-col items-center duration-500"
                ...
                >
                    ...
                    <div class="py-3 w-3/4 flex items-center justify-center">
                        <Link
                            :href="route('login')"
                            class="text-white text-center bg-accent rounded-full px-4 py-2 w-1/2"
                        >
                            Login
                        </Link>
                        <!-- <button
