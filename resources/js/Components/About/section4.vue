<template>
    <section class="pt-16 pb-7 bg-[#F3F4F6]">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-14 border-b-2">
        <div class="flex flex-col gap-8 xl:gap-14 w-full lg:max-w-full mx-auto">
          <div class="flex flex-col gap-8">
            ...
            <div class="flex items-center max-[470px]:justify-center gap-5">
              <a href="javascript:;"
                class="p-2 text-black rounded transition-all duration-500 hover:rounded-full hover:bg-primary focus-within:bg-primary hover:text-white focus-within:outline-0 focus-within:text-white">
              ...
              <a href="javascript:;"
                class="p-2 text-black rounded transition-all duration-500 hover:rounded-full hover:bg-primary focus-within:bg-primary hover:text-white focus-within:outline-0 focus-within:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path
                    ...
                    fill="currentColor" />
                  <path class="fill-white transition-all divide-gray-500 group-hover:fill-primary group-focus-within:fill-primary"
          ...
          <div class="flex  flex-col min-[470px]:flex-row min-[470px]:items-center gap-3">
            <button
              class="flex items-center max-[470px]:justify-center gap-2 py-3 pr-5 pl-7 rounded-full text-base font-semibold text-white bg-primary shadow-transparent shadow-sm transition-all duration-500 hover:shadow-yellow-300 hover:bg-yellow-900">Start
              Project
            ...
            <button
              class="flex items-center max-[470px]:justify-center gap-2 border-2 border-primary py-2.5 pr-5 pl-7 rounded-full text-base font-semibold text-primary bg-white shadow-transparent shadow-sm transition-all duration-500 hover:shadow-yellow-300 hover:bg-primary hover:text-white ">Contact Us
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
          ...
          <div class="">
            ...
            <ul class="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Home</a>
              </li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">About</a>
              </li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Pricing</a>
              </li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Pro
                  Version</a></li>
            </ul>
          </div>
          <div class="">
            ...
            <ul class="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Figma
                  UI System</a></li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Icons
                  Assets</a></li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Responsive
                  Blocks</a></li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Components
                  Library</a></li>
            </ul>
          </div>
          <div class="">
            ...
            <ul class="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-6">
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">FAQs</a>
              </li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Quick
                  Start</a></li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Documentation</a>
              </li>
              <li><a href="javascript:;"
                  class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">User
                  Guide</a></li>
            </ul>
          </div>
        </div>
      ...
      <div class="flex flex-col-reverse gap-5 sm:flex-row items-center first-letter:items-center justify-between pt-7">
        ...
        <ul class="flex items-center gap-9">
          <li><a href="javascript:;" class="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Terms</a></li>
          <li><a href="javascript:;" class="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Privacy</a></li>
          <li><a href="javascript:;" class="text-gray-500 text-sm font-normal transition-all duration-300 hover:text-primary focus-within:outline-0 focus-within:text-primary">Cookies</a></li>
        </ul>
      </div>
    </div>
  </section>
