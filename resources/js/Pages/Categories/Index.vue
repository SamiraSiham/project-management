...
<template>
    ...
    <div class="p-4 bg-white">
        <div class="relative overflow-x-auto flex flex-col items-center shadow-md sm:rounded-lg">
            ...
            <table class="w-[90%] text-md text-left">
                ...
                <tbody>
                    <tr class="bg-white border-b" v-for="i in data" :key="i.id">
                        ...
                        <td class="px-6 py-4 text-right flex justify-between">
                            ...
                            <Link
                                :href="route('categories.destroy', i.id)"
